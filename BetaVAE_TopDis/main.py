...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Beta-VAE (+ TopDis)')
    ...
    parser.add_argument('--beta', default=1, type=float, help='beta hyperparameter')
    ...
    parser.add_argument('--delay_iter', default=0, type=int, help='number of iterations to wait before optimize rtd loss')
    parser.add_argument('--weightnorm_sampler', action='store_true', help='whether to sample dim according to weight norm')
    parser.add_argument('--orthogonalize', action='store_true', help='whether to orthogonalize rtd loss wrt recon loss')
    parser.add_argument('--orthogonalize_all', action='store_true', help='whether to orthogonalize rtd loss wrt vae loss')
    ###
